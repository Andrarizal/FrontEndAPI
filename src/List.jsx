...
export const List = () => {
    ...
    return (
      ...
      <div className="container">
        ...
        {/* Search */}
        {/* dropdown */}
        <select onChange={handleChange} className='btn btn-secondary dropdown-toggle w-100 bg-danger'  id="heroes" name="heroes">
        ...
        <div className="table-responsive">
          <table className="table table-hover">
            ...
            <tbody>
              ...
              <tr key={ index }>
                <td>{index + 1}</td>
                <td className='table-danger'>{ pahlawan.name }</td>
      ...
      <div className="container-fluid py-2 border-top">
        <div className="container text-secondary">
          <small>
            Copyright by Andra Aulia Rizaldy
          </small>
        </div>
      </div>
    </div>
